<template>
  <!-- eslint-disable -->
  <div id="app">
    <div class="_1ADa8 _3Nsgw app-wrapper-web os-win">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
        <span></span>
        <div tabindex="-1" class="_1XkO3 two">
            <div class="snyj76hw an6tjemt jbm6vef4 bbl9m3t3 ora14ekb nv3qcefw"></div>
            <div class="_3ArsE">
                <div class="ldL67 _2i3T7" data-testid="drawer-left">
            ...
            <div class="ldL67 _2i3T7">
                <header data-testid="chatlist-header" class="_1G3Wr">
                    <div class="YtmXM">
                        <div class="_3GlyB" style="height: 40px; width: 40px; cursor: pointer;"><img src="assets/img/185561899_648957876402315_8433794131361574884_n.jpg" alt="" draggable="false" class="_8hzr9 M0JmA i0jNr" style="visibility: visible;"></div>
                    </div>
                    <div class="_3yZPA">
                        <div class="_1QVfy _3UaCz">
                            <span>
                                <div class="_2cNrC" data-testid="menu-bar-status">
                                    <div aria-disabled="false" role="button" tabindex="0" class="_26lC3" data-tab="2" title="Statut" aria-label="Statut">
                                        <span data-testid="status-v3" data-icon="status-v3" class="">
                                            <svg version="1.1" id="ee51d023-7db6-4950-baf7-c34874b80976" x="0" y="0" viewbox="0 0 24 24" width="24" height="24" class="">
                                ...
                                <div class="_2cNrC" data-testid="menu-bar-chat">
                                    <div aria-disabled="false" role="button" tabindex="0" class="_26lC3" data-tab="2" title="Nouvelle discussion" aria-label="Nouvelle discussion">
                ...
                <div id="side" class="_1KDb8">
                    <div tabindex="-1" class="uwk68">
                        <div class="_3yWey _18wEy">
                            <div class="tKJAr">
                                <button data-testid="icon-search-morph" class="_28-cz _1lbUg" aria-label="Rechercher ou démarrer une nouvelle discussion">
                                ...
                                <span></span>
                                <div data-testid="input-placeholder" class="_3Qnsr">Rechercher ou démarrer une nouvelle discussion</div>
                                <div class="_16C8p">
                                    <div tabindex="-1" class="_1UWac _3hKpJ">
                                        <div data-testid="pluggable-input-placeholder" class="_2vbn4" style="visibility: visible;"></div>
                                        <div data-testid="chat-list-search" title="Champ de recherche" role="textbox" class="_13NKt copyable-text selectable-text" contenteditable="true" data-tab="3" dir="ltr"></div>
                                    </div>
                                </div>
                            </div>
                            <button data-tab="4" aria-label="Filtre discussions non lues" title="Filtre discussions non lues" class="tt8xd2xn bugiwsl0 mpdn4nr2 fooq7fky">
                    ...
                    <div class="_3Bc7H _20c87" id="pane-side">
                        <div tabindex="-1" data-tab="4">
                            <div class="" data-testid="chat-list">
                                <div aria-label="Liste de discussions" class="_3uIPm WYyr1" role="grid" aria-rowcount="53" style="height: 3816px;">
  								<chat-link />
							</div>
                            </div>
                        </div>
                        <div class="cm280p3y p357zi0d gndfcl4n ac2vgrno eg3lofc5 gqi0zhd6 pz0xruzv nzcjdldu emrlamx0 swyb62mu tviruh8d">
                            <div class="qfejxiq4 ac2vgrno p357zi0d">
                                <div class="dsh4tgtl e1gr2w1z bsvz8e3l hmy10g0s cw3vfol9">
                                    <span data-testid="lock-small-v2" data-icon="lock-small-v2" class="">
                                        <svg width="13" height="12" viewbox="0 0 13 12" fill="none" preserveaspectratio="xMidYMid meet" class="b9l0eqez kjemk6od l7jjieqr ms8wnqe5">
                                            <path d="M9.54 3.467a3.12 3.12 0 0 0-.437-1.62A3.164 3.164 0 0 0 7.927.67 3.107 3.107 0 0 0 6.313.233c-.587 0-1.13.146-1.626.438A3.232 3.232 0 0 0 3.51 1.847a3.158 3.158 0 0 0-.43 1.62v1.237a1.629 1.629 0 0 0-.842.752c-.086.16-.148.335-.184.526A4.936 4.936 0 0 0 2 6.837V9.25c0 .378.018.663.055.854.036.192.098.367.184.527.155.291.38.517.677.677.155.086.328.148.52.184.196.037.48.055.854.055h4.04c.374 0 .656-.018.848-.055.196-.036.371-.098.526-.184.292-.155.517-.38.677-.677.086-.16.148-.335.184-.527.037-.19.055-.476.055-.854V6.837c0-.378-.018-.663-.055-.855a1.804 1.804 0 0 0-.184-.526 1.615 1.615 0 0 0-.841-.752V3.467Zm-5.168 0c0-.351.087-.675.26-.97a1.916 1.916 0 0 1 1.681-.972 1.916 1.916 0 0 1 1.675.97c.173.297.26.62.26.972V4.54H4.372V3.467Z"></path>
                                        </svg>
                                    </span>Vos messages personnels sont
                                    <a data-testid="clickable-link" class="ajgl1lbb" role="button" rel="noreferrer noopener" target="_blank">chiffrés de bout en bout</a>.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="zaKsw">
                    <div class="_1RAKT">
                        ...
                        <div class="_3q5qB" style="opacity: 1; transform: translateY(0px);">
                            ...
                            <div data-testid="intro-text" class="_1y6Yk">Envoyez et recevez des messages sans avoir à garder votre téléphone connecté.<br>Utilisez WhatsApp sur un maximum de 4 appareils et 1&nbsp;téléphone, simultanément.</div>
                        </div>
                        <div class="_2v0ig">
